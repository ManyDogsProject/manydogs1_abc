...
```{r import-data-pilot}
# Import pilot data
pilot_data <- read_csv(here("data/md1_data_pilot.csv"), show_col_types = FALSE)
```
...
all_data <- read_csv(here("data/md1_data.csv"), show_col_types = FALSE) |> 
...
# Output is saved locally to save time, so this code chunk is not evaluated during knitting
ibs_mat <- fread("data/md1_ibs_matrix.txt", sep = " ", header = FALSE)
ibs_ids <- fread("data/md1_ibs_matrix_ids.txt", sep = "\t", header = FALSE)
